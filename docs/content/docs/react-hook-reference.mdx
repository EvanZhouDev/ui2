...
It is highly recommended that you read the UI2 API Reference and the StatefulIntentCreator Reference first before reading this.
...
The configuration for the React API is identical to that of `createUI2`. Consult that documentation for more information.
