...
<Callout title="Choosing a Model">
It is highly recommended that you use the [Cerebras](https://www.cerebras.ai/) models for their speed. Learn how to set it up on the [Vercel AI SDK Website](https://ai-sdk.dev/providers/ai-sdk-providers/cerebras). However, you can choose any provider you want. The `llama-3.3-70b` model from Cerebras works great.
</Callout>
