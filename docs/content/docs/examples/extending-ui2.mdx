...
Check out both the [`StatefulIntentCreator` documentation](/statefulIntentCreator) and the [React Hook](/react-hook-reference) for inspiration on how to extend UI2 yourself.
