...
_A UI2-powered todo app, showing **Intent Detection** and **Instant Preview**:_
![UI2 Demo](/ui2-todo-demo.gif)
...
Intent detection also represent a leap forward when it comes to [interfaces for future mobile devices](#the-future-of-ui2) like AR/VR where typing is difficult.
