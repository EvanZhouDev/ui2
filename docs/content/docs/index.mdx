...
<Cards>
	<Card title="Intent Identification Quick Start" href="/quick-start/making-ui2-app">
		Identify your first intents with the UI2
	</Card>
	<Card title="Intent Identification API" href="/quick-start/making-ui2-app">
		Explore the powerful and extensible UI2 API
	</Card>
	<Card title="UI2 for React Quick Start" href="/react-quick-start/making-ui2-app">
		Build a UI2 Reminders app
	</Card>
	<Card title="UI2 for React API" href="/quick-start/making-ui2-app">
